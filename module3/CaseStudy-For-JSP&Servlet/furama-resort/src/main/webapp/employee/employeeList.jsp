        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2" style="display: flex;flex-direction: column;margin-top: 104px">
                    ...
                    <a class="btn btn-secondary btn-lg" href="#addEmployeeModal" data-toggle="modal"
                       style="background-color: #996b27; margin: 2px;">Add New Employee</a>
                    <a class="btn btn-secondary btn-lg" href="/customerServlet"
                       style="background-color: #996b27; margin: 2px;">Customer List</a>
                    <a class="btn btn-secondary btn-lg" href="/serviceServlet"
                       style="background-color: #996b27; margin: 2px;">Add New Service</a>
                    <a class="btn btn-secondary btn-lg" href="/contractServlet"
                       style="background-color: #996b27; margin: 2px;">Add New Contract</a>
                </div>
                        ...
                        <c:forEach var="employee" items="${employeeList}">
                            <tr class="contentPage">
                                ...
                                <td>
                                    ...
                                    <a href="/employeeServlet?action=view&id=${employee.id}" class="view" title="View"
                                       data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                    <a href="/employeeServlet?action=edit&id=${employee.id}" class="edit" title="Edit"
                                       data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <a href="/employeeServlet?action=delete&id=${employee.id}" class="delete"
            ...
            <form action="/employeeServlet?action=add" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="idPosition" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"
                    ...
                    <div class="form-group">
                        <label>Degree</label>
                        <select name="idDegree" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            <c:forEach var="degree" items="${degreeList}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="idDepartment" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            <c:forEach var="department" items="${departmentList}">
                                <option value="${department.id}"><c:out
                                        value="${department.nameDepartment}"></c:out></option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
