        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-2" style="display: flex;flex-direction: column;margin-top: 104px">
                    <a class="btn btn-secondary btn-lg" href="/employeeServlet"
                       style="background-color: #996b27; margin: 2px;">Employee List</a>
                    <a class="btn btn-secondary btn-lg" href="#addCustomerModal" data-toggle="modal"
                       style="background-color: #996b27; margin: 2px;">Add New Customer</a>
                        ...
                        <c:forEach var="customer" items="${customerList}">
                            <tr class="contentPage">
                                ...
                                <td>
                                    ...
                                    <a href="/customerServlet?action=view&id=${customer.id}" class="view" title="View"
                                       data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                    <a href="/customerServlet?action=edit&id=${customer.id}" class="edit" title="Edit"
                                       data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <a href="/customerServlet?action=delete&id=${customer.id}" class="delete"
            ...
            <form action="/customerServlet?action=add" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="idCustomerType" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown"
