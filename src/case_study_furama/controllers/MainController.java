...
import case_study_furama.libs.Booking;
import case_study_furama.libs.CabinetDocument;
...
public class MainController {
    ...
    public static void displayCinemaCustomer(Scanner scanner) {
        int inputMenu;
